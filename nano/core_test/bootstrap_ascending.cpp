...
TEST (account_sets, construction)
{
	...
	nano::bootstrap_ascending::account_sets_config config{};
	nano::bootstrap_ascending::account_sets sets{ config, stats };
}
...
{
	nano::bootstrap_ascending::config config1;
	...
	toml2.read (stream2);
	nano::bootstrap_ascending::config config2;
