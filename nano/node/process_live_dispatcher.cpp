...
nano::process_live_dispatcher::process_live_dispatcher (nano::ledger & ledger, nano::scheduler::buckets & scheduler, nano::vote_cache & vote_cache, nano::websocket_server & websocket) :
	ledger{ ledger },
	scheduler{ scheduler },
