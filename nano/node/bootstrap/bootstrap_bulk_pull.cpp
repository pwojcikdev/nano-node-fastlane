...
void nano::bulk_pull_client::request ()
{
	...
	node->nlogger.trace (nano::log::type::bulk_pull_client, nano::log::detail::requesting_account_or_head,
...
void nano::bulk_pull_client::received_block (boost::system::error_code ec, std::shared_ptr<nano::block> block)
{
	...
	node->nlogger.trace (nano::log::type::bulk_pull_client, nano::log::detail::pulled_block, nano::nlogger::arg{ "block", block });
...
void nano::bulk_pull_account_client::request ()
{
	...
	node->nlogger.trace (nano::log::type::bulk_pull_account_client, nano::log::detail::requesting_pending,
...
void nano::bulk_pull_server::send_next ()
{
	...
	if (block != nullptr)
	{
		...
		node->nlogger.trace (nano::log::type::bulk_pull_server, nano::log::detail::sending_block,
...
void nano::bulk_pull_account_server::send_next_block ()
{
	...
	if (block_info_key != nullptr)
	{
		...
		{
			node->nlogger.trace (nano::log::type::bulk_pull_account_server, nano::log::detail::sending_pending,
		...
		{
			node->nlogger.trace (nano::log::type::bulk_pull_account_server, nano::log::detail::sending_block,
