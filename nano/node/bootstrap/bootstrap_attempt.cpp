	...
	mode (mode_a)
{
	...
	node_a->nlogger.debug (nano::log::tag::bootstrap, "Starting bootstrap attempt with ID: {} (mode: {})", mode_text (), id);
...
nano::bootstrap_attempt::~bootstrap_attempt ()
{
	...
	node->nlogger.debug (nano::log::tag::bootstrap, "Exiting bootstrap attempt with ID: {} (mode: {})", mode_text (), id);
