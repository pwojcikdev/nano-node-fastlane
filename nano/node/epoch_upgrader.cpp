...
nano::epoch_upgrader::epoch_upgrader (nano::node & node_a, nano::ledger & ledger_a, nano::store & store_a, nano::network_params & network_params_a, nano::nlogger & nlogger_a) :
	node{ node_a },
	ledger{ ledger_a },
	store{ store_a },
